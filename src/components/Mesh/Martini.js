// Adapted from https://github.com/mapbox/martini/blob/1ca5ca075a169231feb3357c513de774425ff1de/index.js
...
class Tile {
  constructor(terrain, martini) {
    ...
    if (terrain.length !== size * size)
      throw new Error(
        `Expected terrain data of length ${size *
          size} (${size} x ${size}), got ${terrain.length}.`
      );
